 ...
 */
final class Version20200819114959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avatarname VARCHAR(255) NOT NULL, CHANGE picture picture VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE promo_code CHANGE user_id user_id INT DEFAULT NULL, CHANGE expired_at expired_at DATETIME DEFAULT \'NULL\', CHANGE max_number max_number INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP avatarname, CHANGE picture picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
