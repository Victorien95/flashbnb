 ...
 */
final class Version20200819131254 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD ad_cover_image VARCHAR(255) NOT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad DROP ad_cover_image, DROP updated_at');
        $this->addSql('ALTER TABLE booking CHANGE promo_code_id promo_code_id INT DEFAULT NULL');
